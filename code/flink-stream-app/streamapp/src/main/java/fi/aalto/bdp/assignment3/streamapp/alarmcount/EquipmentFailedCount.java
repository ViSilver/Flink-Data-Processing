...
import fi.aalto.bdp.assignment3.streamapp.alarmcount.functions.EquipmentFailedAlarmCollector;
import fi.aalto.bdp.assignment3.streamapp.alarmcount.functions.SplitByAlarmIdFunction;
...
public class EquipmentFailedCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<AlarmRecord> alarms = env
                .addSource(rabbitSource())
                .name("AlarmRecord Source")
                .flatMap(ALARM_RECORD_UNMARSHALLER)
                .setParallelism(5)
                .assignTimestampsAndWatermarks(new LastNEventsWatermark(10))
                .setParallelism(5);
