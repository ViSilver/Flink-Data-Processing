...
import fi.aalto.bdp.assignment3.streamapp.alarmcount.functions.BatteryVoltageAlarmCollector;
...
public class TotalBatteryVoltageCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<AlarmRecord> alarms = env.addSource(rabbitSource())
                                                            ...
                                                            .setParallelism(5)
                                                            .assignTimestampsAndWatermarks(new LastNEventsWatermark(3))
                                                            .setParallelism(5);

        final OutputTag<AlarmRecord> lateEventsTag = new OutputTag<AlarmRecord>("late-events") {};

        SingleOutputStreamOperator<BatteryVoltageAlarm> statistics = alarms
                ...
                .aggregate(new CountingAggregator(), new BatteryVoltageAlarmCollector())
                .setParallelism(5)
    ...
    private static RMQSource<String> rabbitSource() {
        return new RMQSource<>(RABBIT_MQ_CONNECTION_CONFIG,
                               TOTAL_BATTERY_VOLTAGE_QUEUE_NAME,
                               false,
